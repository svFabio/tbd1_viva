-- ==============================================================================
-- 02-seed-fix1.sql
-- Este script actualiza los primeros 20 registros insertados manualmente en 
-- la tabla seguridad."Auditoria" para que su columna detalle_cambio tenga 
-- formato JSON. De esta manera, simularan haber sido generados por un Trigger 
-- DML (ej. usando row_to_json), dando mayor credibilidad a la base de datos 
-- durante la defensa.
-- ==============================================================================
